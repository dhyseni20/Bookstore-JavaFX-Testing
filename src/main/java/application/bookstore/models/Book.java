...
public class Book extends BaseModel<Book> implements Serializable, Cloneable {
    ...
    public static String clearData() {
        return clearData(DATA_FILE, books);
    }
    ...
    public String isValid() {
        ...
        if (!title.matches("([\\p{L}\\p{N}_']\\s*){1,30}"))
    ...
    public boolean equals(Object o) {
        if (o instanceof Book otherBook)
            return otherBook.getIsbn().equals(getIsbn()) && otherBook.getQuantity() == getQuantity() && otherBook.getTitle().equals(getTitle()) && otherBook.getPurchasedPrice() == getPurchasedPrice() && otherBook.getSellingPrice() == getSellingPrice();
        return false;
    }
}
