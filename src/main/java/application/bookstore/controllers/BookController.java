...
public class BookController {
    ...
    public BookController(BookView bookView, boolean customSearch) {
        ...
        if ((View.getCurrentUser().getRole() == Role.ADMIN || View.getCurrentUser().getRole() == Role.MANAGER) && view.isAllowEdit()) {
            setSaveListener();
            setDeleteListener();
            setEditListener();
